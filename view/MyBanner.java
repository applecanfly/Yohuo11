...
import com.example.jinping.yohuo.bean.BannerBean;
...
//    postDelayed() 就可以类比成handler
    ...
    private void init() {
        ...
        addView(pager);
        LayoutParams layoutParams = (LayoutParams) pager.getLayoutParams();
        layoutParams.bottomMargin=DemileUtils.dp2px(10);
        ...
        LayoutParams params = new LayoutParams(LayoutParams.WRAP_CONTENT, DemileUtils.dp2px(20));
        params.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
        params.addRule(RelativeLayout.CENTER_HORIZONTAL);
        params.bottomMargin = DemileUtils.dp2px(20);
...
//                Log.e("tag",content);
                ...
                for(int i=0;i<list.size();i++){
                    ImageView iv = getIv();
                    Picasso.with(getContext()).load(HttpModel.IMGHOST+list.get(i).getImgpath()).fit().error(R.drawable.goods_vip2_icon).into(iv);
                    bannerList.add(iv);
...
//                Toast.makeText(getContext(),msg,Toast.LENGTH_SHORT).show();
    ...
    private View getDot(boolean isWhite) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(DemileUtils.dp2px(10), DemileUtils.dp2px(10));
       params.leftMargin=DemileUtils.dp2px(10);
